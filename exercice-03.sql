...
-- - ET dont la date de création est antérieure au 10 janvier 2021 inclus
SELECT * FROM `student` WHERE created_at >= '2021-01-02' AND created_at <= '2021-01-10';
...
SELECT * FROM `project` WHERE start_date >= '2021-07-01' OR description NOT LIKE '%Dolores%';

-- Exo 3.5
-- Listez les projects :
-- - dont la description ne contient pas la chaîne de caractères `Dolores`
-- - ET dont la date de début est postérieure au 1er juillet 2021 inclus
    SELECT * FROM `project` WHERE start_date >= '2021-07-01' AND description NOT LIKE '%Dolores%';
...
-- - OU ayant un project
SELECT * FROM student WHERE (email LIKE '%.fr%' AND created_at <= '2021-01-10 23:59:59') OR project_id IS NOT null

-- Exo 3.8--
-- Listez les students :
-- - dont l'email contient la chaîne de caractères `.fr` ET la date de création est antérieure au 10 janvier 2021 inclus
-- - ET n'ayant pas de project
SELECT * FROM student WHERE (email LIKE '%.fr%' AND created_at <= '2021-01-10 23:59:59') AND project_id IS  null
